...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int i=0; i < getNumVertices(); i++) {
			int inNeigh = getInNeighbors(i).size();
			int outNeigh = getNeighbors(i).size();
			int degree = inNeigh + outNeigh;
			ds.add(degree);
		}
	...
	public static void main (String[] args) {
		...
		GraphLoader.loadRoadMap("data/maps/hollywood_small.map", graphFromFile); //data/testdata/simpletest.ma
